<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a class="btn btn-primary btn" style="float:right" href="<?php echo site_url(); ?>add-slider">Add Slider
    </a><br><br>
    <div class="card">
            ...
            foreach ($slider as $data){            
              ...
              <tr id="tbl_<?php echo $data['id']; ?>">
                  ...
                  <td class="project-actions text-center">
                      <a class="btn btn-info btn" href="<?= site_url() ?>slider-edit/<?= $data['id']; ?>">
                          <i class="fas fa-edit"></i>
                      </a>
                      <a class="btn btn-danger btn" href="<?php echo base_url()?>slider-delete/<?php echo $data['id']; ?>"
